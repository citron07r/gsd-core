...
function selectRuntimesFromArgs(runtimeArgs) {
  ...
  if (runtimeArgs.includes('--junie')) selected.push('junie');
  return selected;
}
...
function install(isGlobal, runtime = DEFAULT_RUNTIME, options = {}) {
  ...
  const _DESCRIPTOR_AGENTS_RUNTIMES = new Set(['cursor', 'windsurf', 'augment', 'trae', 'codebuddy', 'copilot', 'antigravity', 'droid', 'pi', 'junie']);
